local ui_options = {
	main_color = Color3.fromRGB(0, 217, 255),
			...
			function window_data:AddTab(tab_name)
				...
				local function show()
					...
					for i, v in next, tab_buttons:GetChildren() do
						if not (v:IsA("UIListLayout")) then
							v:GetChildren()[1].ImageColor3 = Color3.fromRGB(22, 31, 46)
					...
					new_button:GetChildren()[1].ImageColor3 = Color3.fromRGB(17, 24, 39)
					...
					function tab_data:AddDropdown(dropdown_name, callback)
						...
						function dropdown_data:Add(n)
							...
							object.MouseLeave:Connect(function()
								object.BackgroundColor3 = Color3.fromRGB(11, 15, 20)
							end)
