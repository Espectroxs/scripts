local ui_options = {
	main_color = Color3.fromRGB(56, 139, 253),
	min_size = Vector2.new(400, 300),
	toggle_key = Enum.KeyCode.RightShift,
	can_resize = true,
}

-- Visual-only theme: dark Linux-style surface, right sidebar tabs, soft contrast.
-- API, callbacks, tabs, dropdowns, keybinds, resize and minimize/maximize logic are preserved.
local linux_style = {
	bg = Color3.fromRGB(9, 13, 22),
	panel = Color3.fromRGB(13, 19, 31),
	sidebar = Color3.fromRGB(16, 24, 38),
	surface = Color3.fromRGB(22, 31, 46),
	surface_hover = Color3.fromRGB(30, 41, 59),
	surface_active = Color3.fromRGB(37, 52, 74),
	border = Color3.fromRGB(48, 61, 82),
...
Label.TextColor3 = linux_style.text
Label.TextSize = 14
...
Window.ImageColor3 = linux_style.bg
...
Tabs.Position = UDim2.new(0, 15, 0, 40)
Tabs.Size = UDim2.new(1, -155, 1, -55)
...
Title.TextColor3 = linux_style.text
Title.TextSize = 16
...
TabSelection.Position = UDim2.new(1, -135, 0, 40)
TabSelection.Size = UDim2.new(0, 120, 1, -55)
TabSelection.Visible = false
TabSelection.Image = "rbxassetid://84145809579840"
TabSelection.ImageColor3 = linux_style.sidebar
...
TabButtons.Position = UDim2.new(0, 0, 0, 8)
TabButtons.Size = UDim2.new(1, 0, 1, -16)
...
Frame.BorderColor3 = linux_style.border
Frame.BorderSizePixel = 0
Frame.Position = UDim2.new(0, -7, 0, 0)
...
TextBox.PlaceholderColor3 = linux_style.muted
TextBox.PlaceholderText = "Input Text"
TextBox.Text = ""
TextBox.TextColor3 = linux_style.text
TextBox.TextSize = 14
...
TextBox_Roundify_4px.ImageColor3 = linux_style.surface
...
Slider.ImageColor3 = linux_style.surface
...
Title_2.Text = "Slider"
Title_2.TextColor3 = linux_style.text
Title_2.TextSize = 14
...
Indicator.ImageColor3 = Color3.fromRGB(56, 139, 253)
...
Value.Text = "0%"
Value.TextColor3 = linux_style.text
Value.TextSize = 14
...
TextLabel.Text = "]"
TextLabel.TextColor3 = linux_style.text
...
TextLabel_2.Text = "["
TextLabel_2.TextColor3 = linux_style.muted
...
Dropdown.TextColor3 = linux_style.text
...
Box.ImageColor3 = linux_style.panel
...
Objects.ScrollBarImageColor3 = linux_style.border
...
TextButton_Roundify_4px.ImageColor3 = linux_style.surface
...
TabButton.TextColor3 = linux_style.text
...
TextButton_Roundify_4px_2.ImageColor3 = linux_style.surface_hover
...
Folder.ImageColor3 = linux_style.panel
...
Button.Text = "      Folder"
Button.TextColor3 = linux_style.text
Button.TextSize = 14
...
TextButton_Roundify_4px_3.ImageColor3 = linux_style.surface_active
...
Console.ImageColor3 = linux_style.panel
...
Source.Text = ""
Source.TextColor3 = linux_style.text
Source.TextSize = 15
...
Lines.Text = "1\n"
Lines.TextColor3 = linux_style.muted
Lines.TextSize = 15
...
ColorPicker.ImageColor3 = linux_style.surface
...
TextButton_Roundify_4px_4.ImageColor3 = Color3.fromRGB(56, 139, 253)
...
Title_3.Text = "Switch"
Title_3.TextColor3 = linux_style.text
Title_3.TextSize = 14
...
TextButton_Roundify_4px_5.ImageColor3 = Color3.fromRGB(56, 139, 253)
...
DropdownButton.BackgroundColor3 = linux_style.panel
DropdownButton.BorderSizePixel = 0
DropdownButton.Size = UDim2.new(1, 0, 0, 20)
DropdownButton.ZIndex = 3
DropdownButton.Font = Enum.Font.GothamBold
DropdownButton.Text = "      Button"
DropdownButton.TextColor3 = linux_style.text
...
Keybind.ImageColor3 = linux_style.surface
...
Title_4.TextColor3 = linux_style.text
Title_4.TextSize = 14
...
Input.Text = "RShift"
Input.TextColor3 = linux_style.text
Input.TextSize = 12
...
Input_Roundify_4px.ImageColor3 = linux_style.surface_hover
	...
	do -- UI Elements
		...
		do -- Add Tab
			function window_data:AddTab(tab_name)
				...
				new_button.Size = UDim2.new(1, -10, 0, 28)
				...
				local function show()
					...
					for i, v in next, tab_buttons:GetChildren() do
						if not (v:IsA("UIListLayout")) then
							v:GetChildren()[1].ImageColor3 = linux_style.surface_hover
							Resize(v, {Size = UDim2.new(1, -10, 0, 28)}, options.tween_time)
						end
					end
					...
					Resize(new_button, {Size = UDim2.new(1, -10, 0, 32)}, options.tween_time)
					new_button:GetChildren()[1].ImageColor3 = options.main_color
					...
					function tab_data:AddDropdown(dropdown_name, callback)
						...
						function dropdown_data:Add(n)
							...
							object.MouseLeave:Connect(function()
								object.BackgroundColor3 = linux_style.panel
							end)
