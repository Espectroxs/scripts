local ui_options = {
	main_color = Color3.fromRGB(88, 101, 242), -- Modern Linux/Hyprland accent
	min_size = Vector2.new(400, 300),
	toggle_key = Enum.KeyCode.RightShift,
	can_resize = true,
	modern_linux_layout = true,
}

--[[ Modern Linux Layout Remodel
	Visual-only pass: dark GNOME/Hyprland-inspired palette, left sidebar tabs,
	softer controls, consistent Gotham typography. Minimize/open logic was preserved.
]]
...
Window.ImageColor3 = Color3.fromRGB(18, 18, 22)
...
Base.ImageColor3 = Color3.fromRGB(24, 24, 28)
...
Top.ImageColor3 = Color3.fromRGB(18, 18, 22)
...
Tabs.Position = UDim2.new(0, 154, 0, 38)
Tabs.Size = UDim2.new(1, -166, 1, -50)
...
TabSelection.Position = UDim2.new(0, 12, 0, 38)
TabSelection.Size = UDim2.new(0, 130, 1, -50)
TabSelection.Visible = false
TabSelection.Image = "rbxassetid://84145809579840"
TabSelection.ImageColor3 = Color3.fromRGB(28, 28, 33)
...
Frame.Position = UDim2.new(1, 6, 0, 0)
...
TextBox_Roundify_4px.ImageColor3 = Color3.fromRGB(36, 36, 42)
...
Slider.ImageColor3 = Color3.fromRGB(36, 36, 42)
...
TextButton_Roundify_4px.ImageColor3 = Color3.fromRGB(36, 36, 42)
...
TabButton.Size = UDim2.new(1, -12, 0, 28)
TabButton.ZIndex = 2
...
TextButton_Roundify_4px_2.ImageColor3 = Color3.fromRGB(33, 33, 39)
...
Folder.ImageColor3 = Color3.fromRGB(30, 30, 35)
...
Console.ImageColor3 = Color3.fromRGB(20, 20, 24)
...
ColorPicker.ImageColor3 = Color3.fromRGB(36, 36, 42)
...
Button_2.Size = UDim2.new(0, 108, 0, 28)
Button_2.ZIndex = 2
...
Keybind.Size = UDim2.new(0, 220, 0, 28)
Keybind.Image = "rbxassetid://2851929490"
Keybind.ImageColor3 = Color3.fromRGB(36, 36, 42)
...
Input_Roundify_4px.ImageColor3 = Color3.fromRGB(49, 49, 56)
	...
	do -- UI Elements
		...
		do -- Add Tab
			function window_data:AddTab(tab_name)
				...
				new_button.Size = UDim2.new(1, -12, 0, 28)
				...
				local function show()
					...
					for i, v in next, tab_buttons:GetChildren() do
						if not (v:IsA("UIListLayout")) then
							v:GetChildren()[1].ImageColor3 = Color3.fromRGB(33, 33, 39)
							Resize(v, {Size = UDim2.new(1, -12, 0, 28)}, options.tween_time)
						end
					end
					...
					Resize(new_button, {Size = UDim2.new(1, -8, 0, 30)}, options.tween_time)
					...
					function tab_data:AddDropdown(dropdown_name, callback)
						...
						function dropdown_data:Add(n)
							...
							object.MouseLeave:Connect(function()
								object.BackgroundColor3 = Color3.fromRGB(36, 36, 42)
							end)
