local ui_options = {
	main_color = Color3.fromRGB(45, 212, 191),
	min_size = Vector2.new(550, 380),
...
Window.ImageColor3 = Color3.fromRGB(8, 11, 15)
Window.ScaleType = Enum.ScaleType.Slice
Window.SliceCenter = Rect.new(12, 12, 12, 12)

local WindowGlow = Instance.new("UIStroke")
WindowGlow.Name = "Glow"
WindowGlow.Parent = Window
WindowGlow.Color = Color3.fromRGB(45, 212, 191)
WindowGlow.Thickness = 1.5
WindowGlow.Transparency = 0.35
...
Bar.Name = "Bar"
Bar.Parent = Window
Bar.BackgroundColor3 = Color3.fromRGB(17, 22, 29)
...
Base.Name = "Base"
Base.Parent = Bar
Base.BackgroundColor3 = Color3.fromRGB(17, 22, 29)
Base.BorderSizePixel = 0
Base.Position = UDim2.new(0, 0, 0.800000012, 0)
Base.Size = UDim2.new(1, 0, 0, 10)
Base.Image = "rbxassetid://2851926732"
Base.ImageColor3 = Color3.fromRGB(17, 22, 29)
...
Tabs.Position = UDim2.new(0, 175, 0, 35)
Tabs.Size = UDim2.new(1, -190, 1, -50)
...
TabSelection.Size = UDim2.new(0, 150, 1, -50)
TabSelection.Visible = false
TabSelection.Image = "rbxassetid://84145809579840"
TabSelection.ImageColor3 = Color3.fromRGB(18, 23, 30)
...
Frame.BackgroundColor3 = Color3.fromRGB(45, 212, 191)
Frame.BorderColor3 = Color3.fromRGB(13, 18, 24)
...
TextBox_Roundify_4px.ImageColor3 = Color3.fromRGB(24, 30, 38)
...
Slider.ImageColor3 = Color3.fromRGB(18, 23, 30)
...
Indicator.ImageColor3 = Color3.fromRGB(45, 212, 191)
...
TextButton_Roundify_4px.ImageColor3 = Color3.fromRGB(24, 30, 38)
...
TabButtonGlow.Name = "Glow"
TabButtonGlow.Parent = TabButton
TabButtonGlow.Color = Color3.fromRGB(45, 212, 191)
TabButtonGlow.Thickness = 1
TabButtonGlow.Transparency = 1
TabButtonGlow.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
...
TabButtonIcon.Position = UDim2.new(0, 8, 0.5, -8)
TabButtonIcon.Size = UDim2.new(0, 16, 0, 16)
TabButtonIcon.Image = "rbxassetid://10723407389"
TabButtonIcon.ImageColor3 = Color3.fromRGB(45, 212, 191)
TabButtonIcon.ZIndex = 3
...
TextButton_Roundify_4px_2.ImageColor3 = Color3.fromRGB(24, 30, 38)
...
Folder.ImageColor3 = Color3.fromRGB(11, 15, 20)
Folder.ScaleType = Enum.ScaleType.Slice
Folder.SliceCenter = Rect.new(4, 4, 4, 4)

Button.Name = "Button"
Button.Parent = Folder
Button.BackgroundColor3 = Color3.fromRGB(17, 22, 29)
...
TextButton_Roundify_4px_3.ImageColor3 = Color3.fromRGB(17, 22, 29)
...
Console.ImageColor3 = Color3.fromRGB(15, 20, 26)
...
RemoteHighlight.TextColor3 = Color3.fromRGB(20, 184, 166)
...
Info.Text = ""
Info.TextColor3 = Color3.fromRGB(34, 211, 238)
Info.TextSize = 15
...
ColorPicker.ImageColor3 = Color3.fromRGB(24, 30, 38)
...
TextButton_Roundify_4px_4.ImageColor3 = Color3.fromRGB(17, 22, 29)
...
Button_2.BackgroundColor3 = Color3.fromRGB(17, 22, 29)
...
TextButton_Roundify_4px_5.ImageColor3 = Color3.fromRGB(17, 22, 29)
...
DropdownButton.BackgroundColor3 = Color3.fromRGB(15, 20, 26)
...
Keybind.ImageColor3 = Color3.fromRGB(24, 30, 38)
...
function library:AddWindow(title, options)
	...
	local user_options = (typeof(options) == "table") and options or {}
	options = {}
	for k, v in next, ui_options do
		options[k] = v
	end
	for k, v in next, user_options do
		options[k] = v
	end
		...
		open_close.MouseButton1Click:Connect(function()
			if canopen then
				...
				if open then
					...
					Window:FindFirstChild("TabSelection").Visible = false
					...
					Window:FindFirstChild("TabSelection").Visible = true
...
local icon_pack = {
	...
	["farm"] = "rbxassetid://10734969693",
	["combat"] = "rbxassetid://10734895783",
	["rebirth"] = "rbxassetid://10709761396",
	["pets"] = "rbxassetid://10734943298",
	["teleport"] = "rbxassetid://10734953549",
	["gift"] = "rbxassetid://10734924712",
	["quests"] = "rbxassetid://10723407389",
	["player"] = "rbxassetid://10734979784",
	["visuals"] = "rbxassetid://10723415756",
	["misc"] = "rbxassetid://10734986316",
	["settings"] = "rbxassetid://10734892526",
...
do -- UI Elements
		...
		do -- Add Tab
			function window_data:AddTab(tab_name, icon)
				...
				new_button.Size = UDim2.new(1, 0, 0, 32)
				new_button.ZIndex = new_button.ZIndex + (windows * 10)
				new_button:GetChildren()[1].ZIndex = new_button:GetChildren()[1].ZIndex + (windows * 10)

				local icon_image = new_button:FindFirstChild("Icon")
				if icon_image then
					local icon_id = icon
					if typeof(icon) == "string" and icon_pack[icon:lower()] then
						icon_id = icon_pack[icon:lower()]
					end
					icon_image.Image = icon_id or icon_pack[tab_name:lower()] or icon_pack.default
					icon_image.ZIndex = icon_image.ZIndex + (windows * 10)
				end
				...
				local function show()
					...
					for i, v in next, tab_buttons:GetChildren() do
						if not (v:IsA("UIListLayout")) then
							v:GetChildren()[1].ImageColor3 = Color3.fromRGB(15, 20, 26)
							local g = v:FindFirstChild("Glow")
					...
					new_button:GetChildren()[1].ImageColor3 = Color3.fromRGB(24, 45, 43)
					local glow = new_button:FindFirstChild("Glow")
